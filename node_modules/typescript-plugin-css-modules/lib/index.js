...
function init(_a) {
    ...
    function create(info) {
        ...
        var processor = postcss_1.default(__spreadArrays(userPlugins, [
        ...
        ts.createLanguageServiceSourceFile = function (fileName, scriptSnapshot) {
            ...
            if (isCSS(fileName)) {
                scriptSnapshot = getDtsSnapshot_1.getDtsSnapshot(ts, processor, fileName, scriptSnapshot, options, logger);
            }
        ...
        ts.updateLanguageServiceSourceFile = function (sourceFile, scriptSnapshot) {
            ...
            if (isCSS(sourceFile.fileName)) {
                scriptSnapshot = getDtsSnapshot_1.getDtsSnapshot(ts, processor, sourceFile.fileName, scriptSnapshot, options, logger);
            }
